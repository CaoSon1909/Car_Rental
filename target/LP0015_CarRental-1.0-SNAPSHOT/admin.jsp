<%-- 
    Document   : admin
    Created on : Feb 21, 2021, 10:49:19 PM
    Author     : ACER
--%>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="main">Car Rental Service - Admin Page</a>
                </div>
                <ul class="nav navbar-nav navbar-right">
                    <li><span style="color: red;">Welcome, ${sessionScope.USER_DTO.fullname}</span></li>
