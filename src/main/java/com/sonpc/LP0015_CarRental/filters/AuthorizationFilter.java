...
//        String resource = uri.substring(lastIndex + 1);
        ...
        //check xem isAuthenticated attribute đã có chưa
        ...
        if (isAuthenticated != null) {
            ...
            //Nếu isAuthenticated chưa tồn tại => resource đó ko cần authenticated
            System.out.println("=====================================");
            chain.doFilter(request, response);
        }
