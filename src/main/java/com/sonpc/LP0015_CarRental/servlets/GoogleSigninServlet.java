...
public class GoogleSigninServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TblUserDTO dto = dao.loginWithGoogleAccount(email, name);
            
            while (dto == null){
                boolean registerResult = dao.registerWithGoogleAccount(email, name);
                dto = dao.loginWithGoogleAccount(email, name);
            }
