...
public class ViewDetailServlet extends HttpServlet {
    ...
    private final String VIEW_DETAIL_PAGE = "view_detail.jsp";
    
    private List<TblOrderDetailDTO> getOrderDetailList(int orderID) throws NamingException, SQLException{
        TblOrderDetailDAO dao = new TblOrderDetailDAO();
        List<TblOrderDetailDTO> list = dao.getOrderDetailByOrderID(orderID);
        if (list != null){
            return list;
        }
        return null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             ...
             List<TblOrderDetailDTO> result = getOrderDetailList(orderID);
             if (result != null){
