 ...
 * @author ACER
 */
public class ActionInCartServlet extends HttpServlet {

    private final String UPDATE_QUANTITY_SERVLET = "UpdateQuantityServlet";
    private final String REMOVE_CAR_FROM_CART_SERVLET = "RemoveCarFromCartServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (button.equals("Update Quantity")) {
                ...
                url = REMOVE_CAR_FROM_CART_SERVLET;
            }
        } finally {
