...
public class SearchHistoryServlet extends HttpServlet {
    ...
    private List<TblOrderDTO> searchOrderListByCarName(String carName) throws NamingException, SQLException {
        TblOrderDAO dao = new TblOrderDAO();
        List<TblOrderDTO> orderList = dao.searchOrderByCarName(carName);
        if (orderList != null) {
            return orderList;
        }
        return null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<TblOrderDTO> list = searchOrderListByCarName(carName);
            if (list != null) {
